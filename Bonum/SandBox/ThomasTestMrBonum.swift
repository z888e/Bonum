        ...
        VStack {
            ...
            ZStack {
                ...
                Path { path in
                    ...
                    // Les épaules :
                    path.addQuadCurve(to: CGPoint(x: 61, y: 45), control: CGPoint(x: 62, y: 31))

                    // Le haut du bras :
                    path.addLine(to: CGPoint(x: 71, y: 60))

                    // La main :
                    path.addQuadCurve(to: CGPoint(x: 68, y: 64), control: CGPoint(x: 72, y: 63))

                    // Le dessous du bras :
                    path.addLine(to: CGPoint(x: 59, y: 52))
                    ...
                    // Dessus de la cuisse :
                    path.addLine(to: CGPoint(x: 68, y: 73))

                    // Le genoux :
                    path.addQuadCurve(to: CGPoint(x: 69, y: 75), control: CGPoint(x: 69, y: 74))
                    
                    // Dessus de la jambe :
                    path.addLine(to: CGPoint(x: 73, y: 96))
                    
                    // Le pied :
                    path.addQuadCurve(to: CGPoint(x: 65, y: 96), control: CGPoint(x: 69, y: 100))

                    // Dessous de la jambe :
                    path.addLine(to: CGPoint(x: 62, y: 79))
